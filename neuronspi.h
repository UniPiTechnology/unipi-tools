...
const uint16_t NEURONSPI_BOARDTABLE[NEURONSPI_BOARDTABLE_LEN][5] = {
	...
	{2, NEURONSPI_BOARD_LOWER_E14RO_ID,		NEURONSPI_BOARD_UPPER_NONE_ID,		0,	0},		// E-14Ro
	{3, NEURONSPI_BOARD_LOWER_E16DI_ID,		NEURONSPI_BOARD_UPPER_NONE_ID,		0,	0},		// E-16Di
	...
	{11, NEURONSPI_BOARD_LOWER_E4AI4AO_ID,	NEURONSPI_BOARD_UPPER_NONE_ID,		0,	0},		// E-4Ai4Ao
	{12, NEURONSPI_BOARD_LOWER_E4AI4AO_ID,	NEURONSPI_BOARD_UPPER_P6DI5RO_ID, 	27, 25},	// E-4Ai4Ao_P-6Di5Ro (xS50)
	{13, NEURONSPI_BOARD_LOWER_B485_ID,		NEURONSPI_BOARD_UPPER_NONE_ID,		0,	0},		// B-485
...
// B_1000 (S103)
#define NEURONSPI_BOARD_B1000_HW_DEFINITION_BLOCK_SIZE 7
...
// E-8Di8Ro (M103)
#define NEURONSPI_BOARD_E8DI8RO_HW_DEFINITION_BLOCK_SIZE 7
...
// E-14Ro
#define NEURONSPI_BOARD_E14RO_HW_DEFINITION_BLOCK_SIZE 7
...
// E-16Di
#define NEURONSPI_BOARD_E16DI_HW_DEFINITION_BLOCK_SIZE 7
...
#define NEURONSPI_BOARD_E8DI8ROP11DIR485_HW_DEFINITION_BLOCK_SIZE 7
...
// E-14Ro_P-11DiR485
#define NEURONSPI_BOARD_E14ROP11DIR485_HW_DEFINITION_BLOCK_SIZE 7
...
// E-16Di_P-11DiR485
#define NEURONSPI_BOARD_E16DIP11DIR485_HW_DEFINITION_BLOCK_SIZE 7
...
// E-14Ro_U-14Ro
#define NEURONSPI_BOARD_E14ROU14RO_HW_DEFINITION_BLOCK_SIZE 7
...
// E-16Di_U-14Ro
#define NEURONSPI_BOARD_E16DIU14RO_HW_DEFINITION_BLOCK_SIZE 7
...
// E-14Ro_U-14Di
#define NEURONSPI_BOARD_E14ROU14DI_HW_DEFINITION_BLOCK_SIZE 7
...
// E-16Di_U-14Di
#define NEURONSPI_BOARD_E16DIU14DI_HW_DEFINITION_BLOCK_SIZE 7
...
// E-4Ai4Ao
#define NEURONSPI_BOARD_E4AI4AO_HW_DEFINITION_BLOCK_SIZE 7
...
// E-4Ai4Ao_P-6Di5Ro
#define NEURONSPI_BOARD_E4AI4AOP6DI5RO_HW_DEFINITION_BLOCK_SIZE 7
...
// B-485
#define NEURONSPI_BOARD_B485_HW_DEFINITION_BLOCK_SIZE 7
...
// E-4Light
#define NEURONSPI_BOARD_E4LIGHT_HW_DEFINITION_BLOCK_SIZE 7
...
// E-4Ai4Ao_U-6Di5Ro
#define NEURONSPI_BOARD_E4AI4AOU6DI5RO_HW_DEFINITION_BLOCK_SIZE 7
...
static struct neuronspi_model_definition NEURONSPI_MODELTABLE[NEURONSPI_MODELTABLE_LEN] = {
		{.name_length = 4, .combination_name = "S103", .combination_count = 1,
				.combinations = NEURONSPI_MODEL_S103_HW_DEFINITION_BOARD},
		{.name_length = 6, .combination_name = "S103IQ", .combination_count = 1,
				.combinations = NEURONSPI_MODEL_S103IQ_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "M103", .combination_count = 2,
				.combinations = NEURONSPI_MODEL_M103_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "M203", .combination_count = 2,
				.combinations = NEURONSPI_MODEL_M203_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "M303", .combination_count = 2,
				.combinations = NEURONSPI_MODEL_M303_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "M403", .combination_count = 2,
				.combinations = NEURONSPI_MODEL_M403_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "M503", .combination_count = 2,
				.combinations = NEURONSPI_MODEL_M503_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "M613", .combination_count = 2,
				.combinations = NEURONSPI_MODEL_M613_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "L203", .combination_count = 3,
				.combinations = NEURONSPI_MODEL_L203_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "L303", .combination_count = 3,
				.combinations = NEURONSPI_MODEL_L303_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "L403", .combination_count = 3,
				.combinations = NEURONSPI_MODEL_L403_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "L503", .combination_count = 3,
				.combinations = NEURONSPI_MODEL_L503_HW_DEFINITION_BOARD},
		{.name_length = 4, .combination_name = "L513", .combination_count = 3,
